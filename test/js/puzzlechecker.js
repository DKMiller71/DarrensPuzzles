...
<input id="Puzzle_Input_PUZZLEID" name="Answer" type="text" width=50 oninput="clearInputState(this);" />
</span><span id="Puzzle_Result_PUZZLEID">&nbsp;</span><br />
<input id="Puzzle_CheckButton_PUZZLEID" name="Check Answer" type="submit" value="Check Answer" />
</form>
</div>
`
...
function showCheckResult(pid, status) {
  ...
  if(status == 'CORRECT') { saveToState(pid); }
...
function init() {
	...
	let data = document.getElementById("answerdata");
	if(!data) { return;}
